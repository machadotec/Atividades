...
class AdiantiCoreTranslator
{
    ...
    private function __construct()
    {
        ...
        $this->messages['en'][] = 'Method ^1 must receive a paremeter of type ^2';
        ...
        $this->messages['en'][] = 'The class ^1 must be subclass of ^2';
        $this->messages['en'][] = 'The class ^1 must be defined';
        ...
        $this->messages['pt'][] = 'A classe ^1 deve ser subclasse de ^2';
        $this->messages['pt'][] = 'A classe ^1 deve estar definida';
